      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            FFButtonWidget(
              onPressed: () async {
                _model.apiresp = await ProfileGroup.changePasswordCall.call(
                  oldPassword: _model.textController1.text,
                  password: _model.textController2.text,
                  passwordConfirmation: _model.textController3.text,
                  bearerAuth: FFAppState().token,
                );

                if ((_model.apiresp?.succeeded ?? true)) {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        ProfileGroup.changePasswordCall.message(
                          (_model.apiresp?.jsonBody ?? ''),
                        )!,
                        style: TextStyle(
                  ...
                  await showDialog(
                    ...
                    builder: (alertDialogContext) {
                      return AlertDialog(
                        title: Text('Error!'),
                        content: Text(ProfileGroup.changePasswordCall.message(
                          (_model.apiresp?.jsonBody ?? ''),
                        )!),
                        actions: [
                          TextButton(
