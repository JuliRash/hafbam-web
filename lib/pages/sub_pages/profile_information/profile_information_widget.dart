...
export 'profile_information_model.dart';

class ProfileInformationWidget extends StatefulWidget {
  const ProfileInformationWidget({super.key});

  static String routeName = 'ProfileInformation';
  static String routePath = 'profileInformation';
...
class _ProfileInformationWidgetState extends State<ProfileInformationWidget> {
  late ProfileInformationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileInformationModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: AuthenticationGroup.loginCall.call(),
      builder: (context, snapshot) {
        ...
        final profileInformationLoginResponse = snapshot.data!;
