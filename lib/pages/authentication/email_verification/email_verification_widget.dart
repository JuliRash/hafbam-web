...
import '/walkthroughs/verify_email.dart';
import '/index.dart';
...
class _EmailVerificationWidgetState extends State<EmailVerificationWidget>
  ...
  void initState() {
    ...
    _model.emailTextController ??=
        TextEditingController(text: 'example@123.com');
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.verifyEmailController = null);
        },
        onSkip: () {
          return true;
        },
