...
import '/walkthroughs/register.dart';
...
class _RegistrationPageWidgetState extends State<RegistrationPageWidget> {
  ...
  void initState() {
    ...
    _model.referralTextController ??= TextEditingController();
  ...
  TutorialCoachMark createPageWalkthrough(BuildContext context) =>
      TutorialCoachMark(
        ...
        onFinish: () async {
          safeSetState(() => _model.registerController = null);
        },
        onSkip: () {
          return true;
        },
