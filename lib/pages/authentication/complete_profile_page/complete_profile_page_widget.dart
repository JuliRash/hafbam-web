...
class _CompleteProfilePageWidgetState extends State<CompleteProfilePageWidget> {
  ...
  void initState() {
    ...
    _model.altPhoneTextController ??= TextEditingController();
    _model.altPhoneFocusNode ??= FocusNode();

    _model.addressTextController ??= TextEditingController();
    _model.addressFocusNode ??= FocusNode();

    _model.lgaTextController ??= TextEditingController();
    _model.lgaFocusNode ??= FocusNode();

    _model.stateTextController ??= TextEditingController();
    _model.stateFocusNode ??= FocusNode();

    _model.bvnTextController ??= TextEditingController();
    _model.bvnFocusNode ??= FocusNode();
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      controller: _model.altPhoneTextController,
                                      focusNode: _model.altPhoneFocusNode,
                                      autofocus: false,
                                      textInputAction: TextInputAction.next,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                      ...
                                      keyboardType: TextInputType.phone,
                                      validator: _model
                                          .altPhoneTextControllerValidator
                                          .asValidator(context),
                                    ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: TextFormField(
                                            controller:
                                                _model.lgaTextController,
                                            focusNode: _model.lgaFocusNode,
                                            autofocus: false,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText: false,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'To generate your unique virtual account for funding your wallet, please verify your BVN or NIN. This ensures a secure and personalized experience.',
                                      style: FlutterFlowTheme.of(context)
                                          .labelSmall
                                          .override(
                                            font: GoogleFonts.inter(
                                    ...
                                    Stack(
                                      children: [
                                        if (_model.radioButtonValue == 'BVN')
                                          TextFormField(
                                            controller:
                                                _model.bvnTextController,
                                            focusNode: _model.bvnFocusNode,
                                            autofocus: false,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText: false,
                                            ...
                                            validator: _model
                                                .bvnTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        if (_model.radioButtonValue == 'NIN')
                                          TextFormField(
                                            controller:
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              _model.completeProfileResponse =
                                  await ProfileGroup.updateProfileCall.call(
                                address: _model.addressTextController.text,
                                gender: _model.genderValue,
                                state: _model.stateTextController.text,
                                lga: _model.lgaTextController.text,
                                phone: _model.phoneTextController.text,
                                bearerAuth: FFAppState().token,
                                name: _model.nameTextController.text,
                                alternatePhone:
                                    _model.altPhoneTextController.text,
                                nin: _model.ninTextController.text,
                                bvn: _model.bvnTextController.text,
                              );

                              if ((_model.completeProfileResponse?.succeeded ??
                                  true)) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      ProfileGroup.updateProfileCall
                                          .responseMessage(
                                        (_model.completeProfileResponse
                                                ?.jsonBody ??
                                            ''),
                                ...
                                FFAppState().user =
                                    ProfileGroup.updateProfileCall.user(
                                  (_model.completeProfileResponse?.jsonBody ??
                                      ''),
                                );
                                FFAppState().update(() {});
