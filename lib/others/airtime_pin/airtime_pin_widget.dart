...
import 'airtime_pin_model.dart';
export 'airtime_pin_model.dart';

class AirtimePinWidget extends StatefulWidget {
  const AirtimePinWidget({super.key});
...
class _AirtimePinWidgetState extends State<AirtimePinWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AirtimePinModel());
