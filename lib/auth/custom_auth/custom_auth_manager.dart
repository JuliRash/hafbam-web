...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    hafbamFinanceAuthUserSubject.add(
      HafbamFinanceAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HafbamFinanceAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HafbamFinanceAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HafbamFinanceAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    hafbamFinanceAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
HafbamFinanceAuthUser? currentUser;
